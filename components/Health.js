...
useEffect(()=>{
    ...
    const url_1="https://newsapi.org/v2/top-headlines?country=us&category=health&apiKey=8c490fcddd8148ab98e6b916e4a9e582";
    axios.get(url_1).then(response=>{
        setNewsArray1(response.data.articles);
    })

    const url_2="https://newsapi.org/v2/top-headlines?country=in&category=health&apiKey=8c490fcddd8148ab98e6b916e4a9e582";
