...
useEffect(()=>{
    ...
    const url_1="https://newsapi.org/v2/top-headlines?country=us&category=technology&apiKey=892a6535a50e4321a237b8389d75cc78";
    axios.get(url_1).then(response=>{
        setNewsArray1(response.data.articles);
    })

    const url_2="https://newsapi.org/v2/top-headlines?country=in&category=technology&apiKey=892a6535a50e4321a237b8389d75cc78";
